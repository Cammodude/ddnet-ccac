...
/*
	        else if(CWarList::IsWar(pLine_->m_ClientId))
		        ChatLogColor = color_cast<ColorRGBA>(ColorHSLA(g_Config.m_CcacBottingPlayerColor));
	        else if(CWarList::IsSus(pLine_->m_ClientId))
                ChatLogColor = color_cast<ColorRGBA>(ColorHSLA(g_Config.m_CcacSusPlayerColor));
	        else if(CWarList::IsTeam(pLine_->m_ClientId))
                {
                    if(g_Config.m_CcacMarkClean)        
            		    ChatLogColor = color_cast<ColorRGBA>(ColorHSLA(g_Config.m_CcacCleanPlayerColor));
                }
